/* PROGRAMMING FUNDAMENTAL'S PROJECT FOR FALL 2023 BS(SE-29A)
...
if(menu_checker)
{
        ...
        sf::Text Name;
        Name.setFont(font);
        Name.setString("Aitazaz & Saad\n Captain Idrees & Haroon");
        ...
        sf::Text UNI;
        UNI.setFont(font);
        UNI.setString("SE-29A");
        UNI.setCharacterSize(12);
        UNI.setFillColor(sf::Color::White);
        UNI.setPosition(280.f, 450.f);

        if (Keyboard::isKeyPressed(Keyboard::Enter)) //If ENTER key is pressed
           menu_checker = false;
